  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var baseHtml =  "<div class='ystep-container'>"+
                      ...
                      "</div>";
      //步骤框架
      var stepHtml = "<li class='ystep-step'>"+
                      "<span class='ystep-step-name'></span><br><br>" +
                      "<span class='ystep-step-detail'></span>" +
                     "</li>";
      //决策器
      var logic = {
        size: {
          ...
          large: function($html){
            var stepCount = $html.find("li").length-1,
            containerWidth = (stepCount*140+140)+"px",
            progressWidth = (stepCount*140)+"px";
            $html.css({
              width: containerWidth
            });
            $html.find(".ystep-progress").css({
      ...
      $(this).each(function(i,n){
        ...
        for(i=0;i<arrayLength;i++){
          ...
          $(".ystep-step-name", $stepHtml).text(_s.title);
          $(".ystep-step-detail", $stepHtml).html(_s.content);
          //将步骤插入到步骤列表中
